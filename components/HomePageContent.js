...
import { yellowDeep, purpleDeep, black, lightGrey } from "@/constants/colors"
import { fifty, fiftySix, sixteen, sixty, thirtyTwo, twentyFour } from "@/constants/fontSizes"
        ...
        <section className=" my-[50px]">
          <ContentWithEyes>
                ...
                <div className="flex mt-[30px] justify-between">
                  <Link 
                    className={`bg-[${purpleDeep}] py-[10px] px-[40px] rounded-[100px] text-[${sixteen}] block`} 
                    href={"/"}
                  >
                    Our Roadmap
                  </Link>
